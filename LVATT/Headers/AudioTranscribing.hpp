...
int TranscribeAudio(int argc, char** argv) {
	whisper_params params;
	//params.fname_inp.push_back(R"(C:\Programing Projects\C++\Project LVATT\build\x64-release\LVATT\Test.wav)");
	//params.n_threads = 14;
	//params.model = R"(C:\Programing Projects\C++\Project LVATT\models\ggml-medium.bin)";
